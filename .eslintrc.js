...
config.rules['sort-keys-fix/sort-keys-fix'] = 0; // disable globally
// FIXME: Linting error in src/app/[variants]/(main)/chat/features/Migration/DBReader.ts, 
// the fundamental solution should be upgrading typescript-eslint
